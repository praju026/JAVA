class FestivalsRunner {
    ...
    public static void main(String args[]) {
        ...
        Festivals fest1 = new Festivals("Diwali","All India","October-November",5,true,"Festival of Lights");
        fest1.GetInfo();
        ...
        Festivals fest2 = new Festivals("Holi","All India","March",2,true,"Festival of Colors");
        fest2.GetInfo();
        ...
        Festivals fest3 = new Festivals("Navratri","Gujarat","September-October",9,false,"Worship of Goddess Durga");
        fest3.GetInfo();
        ...
        Festivals fest4 = new Festivals("Pongal","Tamil Nadu","January",4,true,"Harvest Festival");
        fest4.GetInfo();
        ...
        Festivals fest5 = new Festivals("Onam","Kerala","August-September",10,true,"Homecoming of King Mahabali");
        fest5.GetInfo();
        ...
        Festivals fest6 = new Festivals("Baisakhi","Punjab","April",1,true,"Harvest Festival of Punjab");
        fest6.GetInfo();
        ...
        Festivals fest7 = new Festivals("Ganesh Chaturthi","Maharashtra","August-September",10,false,"Birth of Lord Ganesha");
        fest7.GetInfo();
        ...
        Festivals fest8 = new Festivals("Durga Puja","West Bengal","September-October",5,true,"Worship of Goddess Durga");
        fest8.GetInfo();
        ...
        Festivals fest9 = new Festivals("Eid-ul-Fitr","All India","Varies",1,true,"End of Ramadan");
        fest9.GetInfo();
        ...
        Festivals fest10 = new Festivals("Christmas","All India","December",1,true,"Birth of Jesus Christ");
        fest10.GetInfo();
        ...
        Festivals fest11 = new Festivals("Makar Sankranti","All India","January",1,true,"Harvest and Kite Festival");
        fest11.GetInfo();
        ...
        Festivals fest12 = new Festivals("Raksha Bandhan","All India","August",1,false,"Bond of Brother and Sister");
        fest12.GetInfo();
        ...
        Festivals fest13 = new Festivals("Janmashtami","Uttar Pradesh","August",2,false,"Birth of Lord Krishna");
        fest13.GetInfo();
        ...
        Festivals fest14 = new Festivals("Karva Chauth","North India","October-November",1,false,"Fasting for Husband's Long Life");
        fest14.GetInfo();
        ...
        Festivals fest15 = new Festivals("Bihu","Assam","April",7,true,"Harvest Festival of Assam");
        fest15.GetInfo();
        ...
        Festivals fest16 = new Festivals("Ugadi","Andhra Pradesh","March-April",1,true,"New Year of Andhra & Karnataka");
        fest16.GetInfo();
        ...
        Festivals fest17 = new Festivals("Vishu","Kerala","April",1,true,"Malayalam New Year");
        fest17.GetInfo();
        ...
        Festivals fest18 = new Festivals("Mahashivratri","All India","February-March",1,true,"Worship of Lord Shiva");
        fest18.GetInfo();
        ...
        Festivals fest19 = new Festivals("Ram Navami","All India","March-April",1,true,"Birth of Lord Rama");
        fest19.GetInfo();
        ...
        Festivals fest20 = new Festivals("Buddha Purnima","All India","April-May",1,true,"Birth of Lord Buddha");
        fest20.GetInfo();
