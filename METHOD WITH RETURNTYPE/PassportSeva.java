	...
	static String emailId;
      ...
      public static boolean  registerUser(String gName , String sName,String pwd,String cPwd,String office, String passOffice ,String email){
		   ...
		   // boolean emailIdValid = false;
                    ...
                    boolean isUserValidated = PassportUserValidator.validatePassportUser(gName,sName,pwd,cPwd,office,passOffice,email);
		    if(isUserValidated)
	  ...
	  public static void getUserInfo(){
		...
		password = PassportUserValidator.confirmPassword;
		confirmPassword = PassportUserValidator.regOffice;
		passportOffice = PassportUserValidator.passportOffice;
		regOffice = PassportUserValidator.regOffice;
		emailId = PassportUserValidator.emailId;
	   ...
	   System.out.println("Register to apply at "+regOffice);
	   System.out.println("Passport Office "+passportOffice);
